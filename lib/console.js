...
define(["jquery","dep","styles","mousetrap"],function($,dep,style,mousetrap) {

	

	// Create Twyg Console On Page Load
	window.onLoad = console_show();

	// Toggle/Hide Twyg Console

	var console_toggle = function() {
	...
	mousetrap.bind('P',function () { console_toggle(); });
